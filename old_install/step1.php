...
<?php
    ...
    <div class="alert alert-danger">
        ...
        if ($check['mysql'] === false) {
            echo '<br />Please check if you have installed mysql.';
        }
        ?>
    </div>
<?php
...
<table class="table">
    ...
    <tr>
        ...
        <td><span class="label label-<?php echo $check['mysql_css']; ?>"><?php echo $check['mysql_version']; ?></span>
        </td>
    </tr>
    <tr>
