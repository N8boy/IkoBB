...
define('MYSQL_HOST', 'localhost');  // Your SQL host                             Default: localhost
define('MYSQL_USERNAME', 'root'); // Your SQL username
define('MYSQL_PASSWORD', ''); // Your SQL password
define('MYSQL_DATABASE', 'IkoBB'); // Your SQL Database for IkoBB
define('MYSQL_PREFIX', 'iko_'); // The prefix for this forum              Default: iko_
define('MYSQL_PORT', 3306); // The port to your SQL                                 Default: 3306

/**
 * Iko local details
 */
define('SITE_URL', 'http://192.168.1.103/Ikobb/Ikobb'); // Without the ending "/"
